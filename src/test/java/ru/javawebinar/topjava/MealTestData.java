...
public class MealTestData {
    ...
    public static final Meal meal4 = new Meal(USER_MEAL_ID + 3, of(2020, Month.JANUARY, 31, 00, 0), "Еда на граничное значение", 100);
    ...
    public static final Meal meal7 = new Meal(USER_MEAL_ID + 6, of(2020, Month.JANUARY, 31, 20, 0), "Ужин", 510);
    ...
    public static Meal getUpdated() {
        return new Meal(USER_MEAL_ID, of(2020, Month.MAY, 30, 9, 30), "Обновленный завтрак", 200);
    }
